...
class ItemController(BaseController):
 ...
 # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
    ...
    def post_item(self, nombre_item, adjunto, complejidad, estado, id_tipo_item,fecha_creacion):
        ...
        item = Item (nombre_item=nombre_item, codigo_item=codigo_item,id_tipo_item=id_tipo_item, adjunto=adjunto,
						complejidad=complejidad, estado = estado ,fase=1, 
						proyecto=1,creado_por =request.identity['repoze.who.userid'], 
