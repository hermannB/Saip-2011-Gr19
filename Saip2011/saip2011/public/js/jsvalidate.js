...
var custom_validators = {
	number: {
		...
		defaultMessage: "Debe tener un valor numerico.",
		regExp: /^[-]?\d+(\.\d+)?$/
	},
	digits: {
		className: "jsvalidate_digits",
		defaultMessage: "Solo puede contener numeros.",
		regExp: /^[-]?\d+(\.\d+)?$/
	},
	email: {
		className: "jsvalidate_email",
		defaultMessage: "Ingrese un formato de email valido.",
	...
	alpha: {
		...
		defaultMessage: "Solo puede contener letras.",
		regExp: /^[a-zA-z\s]+$/
	},
	alphanum: {
		className: "jsvalidate_alphanum",
		defaultMessage: "Solo alfanumericos.",
		regExp: /^[a-zA-Z0-9]+$/
	}
};
...
var js_validators = {
	...
	notfirst: {
		...
		defaultMessage: "Seleccione otro que no sea el primero."
	},
	filetypes: {
		defaultMessage: "Acepta los siguientes tipos:"
	}
};
